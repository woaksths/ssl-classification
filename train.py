...
unlabeled_dataset = [(text,label) for text, label in zip(unlabeled_text, unlabeled_label)]
...
ssl_trainer.train(labeled_data = train_dataset, unlabeled_data=unlabeled_dataset,
                  dev_data=val_dataset, test_data = test_dataset, outer_epoch=20, inner_epoch=20)
